<template>
  <div>
    <div class="view">
      <div class="view-title">Quản lý tài khoản khách hàng</div>
      <div class="card">
        <div class="card-item">
...
export default {
  ...
  methods: {
    ...
    yes() {
      this.$axios
        .delete(`${api.CustomerApi}/${this.item.id}`)
        .then(() => {
          this.title = "Cập nhật hệ thống thành công.";
          this.hasToast = true;
          setTimeout(() => {
    ...
    getCustomer() {
      ...
      this.hasLoader = true;
      this.$axios
        .get(`${api.CustomerApi}/pagination`, { params: param })
        .then((res) => {
