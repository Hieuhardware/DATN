<template>
  <div class="form-container">
    <div class="form-content">
      ...
      <div class="form-body">
        <div class="form-body-item form-body-top">
          <div class="label">
            Họ tên người nhận hàng<span style="color: red"> * </span>:
          </div>
          <div class="value">
      ...
      <div class="form-footer">
        ...
        <button class="button" v-if="this.statusData == 0" @click="addItem()">
          Thêm mới
        </button>
        <button
          class="button"
...
export default {
  ...
  methods: {
    getDetailOrders() {
      this.$axios
        .get(`${api.OrderDetailApi}/${this.order.id}`)
        .then((res) => {
    ...
    updateItem() {
      ...
      this.$axios
        .put(`${api.OrderApi}/${this.order.id}`, this.order)
        .then(() => {
          this.$emit("close");
          this.$emit("success");
        })
